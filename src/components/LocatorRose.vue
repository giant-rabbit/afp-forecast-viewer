        ...
        <div :class="$style.roseContainer">
            ...
            >
                <path
                    ...
                    style="stroke: #C8CACE; stroke-width: 10px; fill: transparent"
                />
                <path
    ...
    methods: {
        roseColor() {
            ...
            this.location.forEach(function (each) {
                rose.querySelector('[data-id="' + each + '"]').style.fill = '#515558'
            })
        },
    },
    mounted() {
        this.roseColor()
        // var svg = document.querySelector('#problem-' + this.rank + ' .afp-rose-svg')
        // var img = document.querySelector('#problem-' + this.rank + ' .afp-rose-img')
